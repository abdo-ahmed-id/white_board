...
class RoomTestPage extends WhiteExamplePage {
  ...
  Widget build(BuildContext context) {
    return const RoomTestBody();
  }
}

class RoomTestBody extends StatefulWidget {
  const RoomTestBody({super.key});
...
class RoomTestBodySate extends State<RoomTestBody> {
  ...
  RedoStepsUpdatedCallback get _onCanRedoStepsUpdate => (stepNum) {
        print('can redo step : $stepNum');
      };

  UndoStepsUpdatedCallback get _onCanUndoStepsUpdate => (stepNum) {
        print('can undo step : $stepNum');
      };

  RoomStateChangedCallback get _onRoomStateChanged => (newState) {
        print('room state change : ${newState.toJson()}');
      };

  RoomPhaseChangedCallback get _onPhaseChanged => (phase) {
